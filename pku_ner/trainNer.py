...
class trainNer:
    ...
    wordNum = 0             # words num
    # wordPosFreq[word] = {pos1:fre1,pos2:fre2}. word and its pos:frequency
    wordPosFreq = {}       
    posFreq = {}            # posFreq[pos] = fre. pos and its frequency
    # posTransFreq[pos] = {pos1:frq1,pos2:frq2}. frequency of pos transferring to pos_x
    posTransFreq = {}   
     # posTransPro[pos] = {pos1:pro1,pos2:pro2}. probability of pos transferring to pos_x    
    posTransPro = {}    
    # wordPosHeadFreq[word] = {pos1:fre1,pos2:fre2}. word and its frequency of being the head of sentence as pos
    wordPosHeadFreq = {}    
    # wordPosHeadPro[word] = {pos1:pro1,pos2:pro2}. word and its probability of being the head of sentence as pos
    wordPosHeadPro = {}     
        ...
        for sent in self.trainSents:
            ...
            for pair in sent:
                ...
                if index == 0:# 句首
                    ...
                    # 统计该词以该词性出现在句首的频数
                    if word in self.wordPosHeadFreq.keys():
                        # 字典里存在该词
                    ...
                    prePos = currPos
                    currPos = pos
                    if prePos in self.posTransFreq.keys():  # 记录句中两种词性相邻的次数
